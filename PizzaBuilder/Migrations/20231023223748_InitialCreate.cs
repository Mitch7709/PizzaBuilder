    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ToppingsToPizzas", x => new { x.PizzaID, x.ToppingID });
                    table.ForeignKey(
                        name: "FK_ToppingsToPizzas_Pizzas_PizzaID",
                        column: x => x.PizzaID,
                        principalTable: "Pizzas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ToppingsToPizzas_Toppings_ToppingID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ToppingsToPizzas_ToppingID",
                table: "ToppingsToPizzas",
                column: "ToppingID");
        }
